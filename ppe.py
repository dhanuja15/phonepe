...
#sql connection
mydb = db.connect(host="localhost",user='root',password='root',database='phonepe')
cursor = mydb.cursor()
...
if selected == "Analysis":
            ...
            try:
                ...
                if in_us_tab_qry_rslt:
                    ...
                    if in_us_co_qry_rslt:
                        df_in_us_co_qry_rslt = pd.DataFrame(in_us_co_qry_rslt, columns=['Total', 'Average'])
                        ...
                        df_state_names_use['User Count'] = df_in_us_tab_qry_rslt['User Count'].values
                        ...
                        st.write("No total user count data found for the selected year and quarter.")

                else:
                    st.write("No user data found for the selected year and quarter.")
    ...
    if select == "STATES":
        ...
        with tab3:
            ...
            try:
                #Transaction Analysis bar chart query
                cursor.execute(f"SELECT District,Transaction_Amount FROM map_transaction WHERE State= '{st_tr_st}' AND Year = '{st_tr_yr}' AND Quarter = '{st_tr_qtr}';")
                ...
                # Transaction Analysis table query
                cursor.execute(f"SELECT District, Transaction_Count, Transaction_Amount FROM map_transaction WHERE State = '{st_tr_st}' AND Year = '{st_tr_yr}' AND Quarter = '{st_tr_qtr}';")
                ...
                # Total Transaction Amount table query
                cursor.execute(f"SELECT District,SUM(Transaction_Amount), AVG(Transaction_Amount) FROM map_transaction WHERE State = '{st_tr_st}' AND Year = '{st_tr_yr}' AND Quarter = '{st_tr_qtr}'  group by District;")
                ...
                # Total Transaction Count table query
                cursor.execute(f"SELECT District,SUM(Transaction_Count), AVG(Transaction_Count) FROM map_transaction WHERE State = '{st_tr_st}' AND Year ='{st_tr_yr}' AND Quarter = '{st_tr_qtr}' group by District;")
        ...
        with tab4:
            ...
            try:
                ...
                try:
                    ...
                    cursor.execute(f"SELECT District, SUM(Registered_Users) FROM map_user WHERE State = '{st_us_st}' AND Year = '{st_us_yr}' AND Quarter = '{st_us_qtr}' GROUP BY District;")
                    ...
                    # Total User Count table query
                    cursor.execute(f"SELECT District,SUM(Registered_Users), AVG(Registered_Users) FROM map_user WHERE State = '{st_us_st}' AND Year = '{st_us_yr}' AND Quarter = '{st_us_qtr}' GROUP BY District;")
    ...
    if select == "TOP CATEGORIES":
        ...
        with tab5:
            ...
            cursor.execute(
                f"SELECT State, SUM(Transaction_Amount) As Transaction_amount FROM top_transaction_pincode WHERE Year = '{top_tr_yr}' GROUP BY State ORDER BY Transaction_amount DESC LIMIT 10;")
            ...
            cursor.execute(
                f"SELECT State, SUM(Transaction_Amount) as Transaction_amount, SUM(Transaction_Count) as Transaction_count FROM top_transaction_pincode WHERE Year = '{top_tr_yr}' GROUP BY State ORDER BY Transaction_amount DESC LIMIT 10;")
        ...
        with tab6:
            ...
            cursor.execute(f"SELECT State, SUM(Registered_Users) AS Top_user FROM top_user_pincode WHERE Year='{top_us_yr}' GROUP BY State ORDER BY Top_user DESC LIMIT 10;")
...
if selected == "Insights":
    ...
    if select == "Top 10 states based on year and amount of transaction":
        cursor.execute(
            "SELECT DISTINCT State, SUM(Transaction_Amount) AS Total_Transaction_Amount FROM top_transaction_pincode GROUP BY State ORDER BY Total_Transaction_Amount DESC LIMIT 10");
    ...
    #2
        ...
        cursor.execute(
            "SELECT DISTINCT State,Year, SUM(Transaction_Amount) as Total FROM top_transaction_pincode GROUP BY State, Year ORDER BY Total ASC LIMIT 10");
        data = cursor.fetchall()
    ...
    #3
        ...
        cursor.execute("SELECT DISTINCT State, Pincode, SUM(Registered_Users) AS Users FROM top_user_pincode GROUP BY State, Pincode ORDER BY Users DESC LIMIT 10");
        data = cursor.fetchall()
    ...
    #4
        ...
        cursor.execute("SELECT DISTINCT State, Pincode, SUM(Registered_Users) AS Users FROM top_user_pincode GROUP BY State, Pincode ORDER BY Users ASC LIMIT 10");
        data = cursor.fetchall()
        columns = ['State', 'District_Pincode', 'Registered_User']
        df = pd.DataFrame(data, columns=columns, index=range(1, len(data) + 1))
        col1, col2 = st.columns(2)
    ...
    #5
        ...
        data = cursor.fetchall()
        columns = ['State', 'District', 'Transaction_Amount']
        df = pd.DataFrame(data, columns=columns, index=range(1, len(data) + 1))
        col1, col2 = st.columns(2)
        with col1:
            st.write(df)
    ...
    #10
        ...
        cursor.execute(
            "SELECT DISTINCT Brand,SUM(Count) as Total FROM aggregated_user GROUP BY Brand ORDER BY Total DESC LIMIT 10");
        data = cursor.fetchall()
